...
def html_test(target, ts_range):
    return """
    <!DOCTYPE html>
    <html>
    <head>
    <title> This is HTML content displayed on a Grafana panel</title>
    </head>
    <body>

    <h1>Bokeh test</h1>
    <p>Passed parameter is %d</p>

    </body>
    </html>
    """% (int(target),)

#def bokeh_test(target, ts_range):
    return """<!DOCTYPE html>\n<html lang="en">\n  \n  <head>\n    \n	   <meta charset="utf-8">\n	 <title>my plot</title>\n      \n      \n        \n          \n        \n        \n          \n    $

def cpu2t_graph(target, ts_range):
    return """<!DOCTYPE html>\n<html lang="en">\n  \n  <head>\n    \n	   <meta charset="utf-8">\n	 <title>CPU2 Plot</title>\n	 \n	 \n        \n          \n        \n        \n          \n  $

def series_graph(target, ts_range):
    return """<!DOCTYPE html>\n<html lang="en">\n  \n  <head>\n    \n	   <meta charset="utf-8">\n	 <title>my plot</title>\n      \n      \n        \n          \n        \n        \n          \n    $

def job_graph(target, ts_range):
    #return """<!DOCTYPE html>\n<html lang="en">\n  \n  <head>\n    \n      <meta charset="utf-8">\n	  <title>Job Plot</title>\n	 \n	 \n        \n          \n        \n        \n          \n  $
    return """ <!DOCTYPE html>\n<html lang="en">\n  \n  <head>\n    \n      <meta charset="utf-8">\n	  <title>Job Plot</title>\n	 \n	 \n        \n          \n        \n        \n          \n  $

def power_graph(target, ts_range):
...
if __name__ == '__main__':
    ...
    def get_sine(freq, ts_range):
        ...
        df = pd.Series(np.sin(np.arange(len(ts)) * np.pi * freq * 2 / float(len(ts))), index=ts).to_frame('value')
    ...
    #add_panel_reader('html', html_test)

    #add_panel_reader('html', bokeh_test)

    add_panel_reader('html', cpu2t_graph)

    add_panel_reader('new_html', series_graph)

    add_panel_reader('another_html', job_graph)

    add_panel_reader('power_html', power_graph)

    add_panel_reader('temp_html', temp_graph)
